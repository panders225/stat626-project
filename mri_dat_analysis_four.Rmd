...
The ACF cuts off after around lag 1_s_ (_s_=15) and the PACF tails off with .  This suggests an SMA model.  We can easily try out a few models and see how the fits are.
